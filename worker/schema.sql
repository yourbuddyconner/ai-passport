...
CREATE TABLE IF NOT EXISTS sessions (
  ...
  subagent_input_tokens INTEGER NOT NULL DEFAULT 0,
  subagent_output_tokens INTEGER NOT NULL DEFAULT 0,
  subagent_cache_read_tokens INTEGER NOT NULL DEFAULT 0,
  subagent_cache_creation_tokens INTEGER NOT NULL DEFAULT 0,
